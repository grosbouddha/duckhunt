...
function SoundManager(smURL, smID) {
  ...
  this.debugMode = AppConf.debug;             // enable debugging output (div#soundmanager-debug, OR console if available+configured)
...
if (typeof SM2_DEFER === 'undefined' || !SM2_DEFER) {
  soundManager = new SoundManager(AppConf.serverRoot +  '/externalLib/soundManager/', {autoplay: true});
}
